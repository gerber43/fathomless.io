...
<html>
    ...
    <body onresize="scaleTextures()">
        ...
        <script>
            ...
            var music = playMusic = sfx = isLowResolution = start = disableMovement = playAudio = closeSetting = isSettingsOpen = currentMap = viewDiameter  = inventoryOpened = asciiMode= 0;
